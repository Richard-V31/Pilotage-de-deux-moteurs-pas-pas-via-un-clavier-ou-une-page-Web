...
#define FACTEUR_1PASS 5  // Variable a modifier pour le Mode 1Pas+
...
<div class="moteur">
  ...
  <div class="step-row">
    ...
    <!-- 🟢 Case à cocher "xFACTEUR_1PASS" : force la vitesse du mode "1 Pas" pour le Moteur 1 -->
    <!-- L'étiquette est générée depuis la macro FACTEUR_1PASS : toujours cohérente avec la vitesse réellement appliquée -->
    <div class="pas5-bloc">
      <label class="switch">
        <input type="checkbox" id="m1pas5" onchange="pas5Change('m1', this.checked)">
        <span class="slider-switch"></span>
      </label>
      <span>x)HTML" STR(FACTEUR_1PASS) R"HTML(</span>
    </div>
  </div>
...
<div class="moteur">
  ...
  <div class="step-row">
    ...
    <!-- 🟢 Case à cocher "xFACTEUR_1PASS" : force la vitesse du mode "1 Pas" pour le Moteur 2 -->
    <!-- L'étiquette est générée depuis la macro FACTEUR_1PASS : toujours cohérente avec la vitesse réellement appliquée -->
    <div class="pas5-bloc">
      <label class="switch">
...
void loop() {
  ...
  if (step1) {
    ...
    float vitesseManuelleM1 = pas5M1 ? (vitesseManuelle * FACTEUR_1PASS) : vitesseManuelle;  // 🟢 xFACTEUR_1PASS si la case est cochée
  ...
  if (step2) {
    ...
    float vitesseManuelleM2 = pas5M2 ? (vitesseManuelle * FACTEUR_1PASS) : vitesseManuelle;  // 🟢 xFACTEUR_1PASS si la case est cochée
